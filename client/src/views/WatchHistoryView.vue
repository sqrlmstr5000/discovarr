  ...
  <div class="relative p-6 md:p-8 text-white overflow-x-hidden h-full overflow-y-auto">
    <div class="flex justify-between items-center mb-8">
      ...
      <button
        @click="handleSync"
        :disabled="isSyncing"
        class="p-2 sm:p-3 bg-aiarr text-white rounded-full shadow-lg hover:bg-aiarr-dark focus:outline-none focus:ring-2 focus:ring-aiarr-light focus:ring-opacity-75 transition-colors duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
    ...
    <div v-if="loading" class="flex flex-col items-center justify-center py-20 text-gray-400">
      <svg class="animate-spin h-12 w-12 text-aiarr mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
