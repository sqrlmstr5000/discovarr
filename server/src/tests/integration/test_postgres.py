...
from services.models import Settings, database as db_proxy, MODELS
...
def postgres_db_setup(monkeypatch):
    """
    ...
    try:
        ...
        db_instance = Database(db_path="/tmp/dummy_sqlite_for_postgres_test.db") # Path is irrelevant for PG
